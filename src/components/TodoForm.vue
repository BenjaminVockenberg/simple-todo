          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <button 
                ...
                type="button" 
                @click="element.addDone = !element.addDone">{{ element.addDone ? 'undone' : 'done' }}</button>&nbsp;
              <button 
                class="btn btn-danger" 
                type="button" 
                name="delete" 
                @click="deleteItem(index)">x</button>
            </div>
          </div>
        </li>
      </ul>
